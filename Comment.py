...
class Comment:
    ...
    def __init__(self, url,comment_id=None, question_id=None, answer_id=None, author_id=None,content=None, time=None, vote_num=0):
    ...
    def get_comment_id(self):
        ...
        soup = self.soup
        comment_id = soup.find("div", class_="_CommentItem_root_PQNS").find("div", class_="_CommentItem_body_3qwB").find("div", class_="_CommentItem_content_CYqW")["data-reactid"].string
        return comment_id
    ...
    def get_detail(self):
        soup = self.soup
        detail = str(
            soup.find("div",class_="_CommentItem_content_CYqW")
         )
    ...
    def get_time(self):
        ...
        soup = self.soup
        time = str(
            soup.find("div",class_="_CommentItem_root_PQNS").find("div",class_="_CommentItem_body_3qwB").find("div",class_="_CommentItem_footer_46v8 clearfix").find("time")["title"]
         )
        return time
    ...
    def get_vote_num(self):
        ...
        try:
            vote =  str(
                soup.find("div",class_="_CommentItem_root_PQNS").find("div",class_="_CommentItem_body_3qwB").find("div",class_="_CommentItem_footer_46v8 clearfix").find("span",class_="_CommentItem_likes_2hey").span
            )
        except:
            pass
        finally:
